...
# Ove@rightscale.com
#
# Uses CloudStack API to Delete a template 
#
#
...
begin
config = YAML::parse(File.open("del.yml")).transform
rescue
puts "Can't find del.yml file - Please create first"
exit
end
...
# API call that will get executed against the endpoint
# Some of these commands require you to have DOMAIN ADMIN priviledges!

api_calls = "#{@CLOUD['command']}" + "&id=#{@CLOUD['id']}"
